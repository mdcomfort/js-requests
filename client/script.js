...
function sayHelloColorChange(event) {
    sayHelloButton.style.backgroundColor = 'black'
    sayHelloButton.style.color = 'white'
}

sayHelloButton.addEventListener('mouseover', sayHelloColorChange)
...
sayHelloButton.addEventListener('mouseleave', changeColorBack)
...
const createFood = (event) => {
    ...
    .then((res) => {
        ...
        document.querySelector('body').appendChild(newListItem)
        foodInput.value = ''
    })
}
